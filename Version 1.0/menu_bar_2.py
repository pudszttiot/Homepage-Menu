...
class MyApp(QMainWindow):
    ...
    def show_how_to_use_dialog(self):
        ...
        <html>
            <body>
                <h1 style="color: #0074D9;">How to Use My PyQt Application</h1>
                <p>Welcome to My PyQt Application</p>
                <h2 style="color: #2ECC40;">This is a simple template for a PyQt application.</h2>
                <p>Click the buttons.</p>
                <h2 style="color: #FF4136;">Here's how to use it:</h2>
                <p>This is a simple template for a PyQt application.</p>
                <ul>
                    <li><strong>File:</strong> Click on the "File" menu to perform file-related actions.</li>
                    <li><strong>Help:</strong> Click on the "Help" menu and select "How to Use" to see this dialog.</li>
                </ul>
                <p>That's it! You can now customize this application as needed.</p>
                <h2 style="color: #FF851B;">Here's how to use it:</h2>
                <p>This is a simple template for a PyQt application.</p>
        ...
        how_to_use_dialog.setIcon(QMessageBox.Information)
